...
from model.util.helpers import expand_left
from model.util.jit import class_from_module_repr
from model.util.typings import (sanitize, split_types_repr, parse_types,
                            resolve_types)
from model.util.inspector import Inspector, func_header_repr, func_body_repr
...
class MessagePassing2(torch.nn.Module):
    ...
    def propagate(self, edge_index: Adj, size: Size = None, **kwargs):
        ...
        # Otherwise, run both functions in separation.
            ...
            out_agg = self.aggregate(out, **aggr_kwargs)

            update_kwargs = self.inspector.distribute('update', coll_dict)
            return self.update(out_agg, **update_kwargs), out
